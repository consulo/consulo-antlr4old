...
public interface ANTLRv4ParserListener extends ParseTreeListener {
	...
	/**
	 * Enter a parse tree produced by {@link ANTLRv4Parser#elements}.
	 * @param ctx the parse tree
	 */
	void enterElements(@NotNull ANTLRv4Parser.ElementsContext ctx);
	/**
	 * Exit a parse tree produced by {@link ANTLRv4Parser#elements}.
	 * @param ctx the parse tree
	 */
	void exitElements(@NotNull ANTLRv4Parser.ElementsContext ctx);
	 ...
	 * @param ctx the parse tree
	 */
	void enterLexerRule(@NotNull ANTLRv4Parser.LexerRuleContext ctx);
	/**
	 * Exit a parse tree produced by {@link ANTLRv4Parser#lexerRule}.
	 * @param ctx the parse tree
	 */
	void exitLexerRule(@NotNull ANTLRv4Parser.LexerRuleContext ctx);
